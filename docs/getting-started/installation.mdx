...
<Step title="Inicializar Bases de Datos (Opcional)">

La configuración de Docker Compose inicializa las bases de datos automáticamente. Para configuración manual:
