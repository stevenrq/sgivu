...
Limited exposed actuator endpoints to health and info
...
- **Requires Restart**: Sí, se debe reiniciar el servicio sgivu-auth
...
1. **Usa ramas feature** - Nunca hagas commit directo a main
2. **Escribe commits descriptivos** - Explica qué cambiaste, por qué y dónde
3. **Documenta cambios críticos** - Seguridad, rendimiento y dependencias requieren más detalle
4. **Sincroniza entre entornos** - Mantén puertos, URLs y estructuras consistentes
5. **Prueba antes de hacer merge** - Valida localmente con Docker Compose
6. **Entiende la propagación** - Ten claro cómo llegan los cambios a los servicios en ejecución
7. **Ten plan de rollback** - Prepárate para revertir rápido si aparece un problema
8. **Monitorea después de cambios** - Revisa logs y métricas tras desplegar cambios de configuración
9. **Revisa en equipo** - Los cambios de configuración deben revisarse como el código
10. **Mantén el historial limpio** - Usa commits claros y evita force push salvo necesidad justificada
