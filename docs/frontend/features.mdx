...
- Scroll vertical interno cuando la tabla supera la altura máxima del contenedor
- Encabezado fijo para tablas largas
...
### Permisos de personas y empresas

- `person:read`, `person:create`, `person:update`, `person:delete` — Gestión de personas (clientes individuales).
- `company:read`, `company:create`, `company:update`, `company:delete` — Gestión de empresas (clientes empresariales).
