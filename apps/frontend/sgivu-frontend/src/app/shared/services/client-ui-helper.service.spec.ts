...
describe('ClientUiHelperService', () => {
  ...
  describe('updatePersonStatus()', () => {
    it('should show confirmation dialog and update person status on confirm', async () => {
    ...
    it('should show error dialog when person status update fails', async () => {
      const onSuccessSpy = jasmine.createSpy('onSuccess');
    ...
    it('should use default description when personName is not provided', async () => {
      const onSuccessSpy = jasmine.createSpy('onSuccess');
      personServiceSpy.updateStatus.and.returnValue(of({} as any));
    ...
    it('should use correct action text when activating (nextStatus=true)', async () => {
      const onSuccessSpy = jasmine.createSpy('onSuccess');
      personServiceSpy.updateStatus.and.returnValue(of({} as any));
  ...
  describe('updateCompanyStatus()', () => {
    it('should show confirmation dialog and update company status on confirm', async () => {
      const onSuccessSpy = jasmine.createSpy('onSuccess');
    ...
    it('should show error dialog when company status update fails', async () => {
      const onSuccessSpy = jasmine.createSpy('onSuccess');
    ...
    it('should use default description when companyName is not provided', async () => {
      const onSuccessSpy = jasmine.createSpy('onSuccess');
      companyServiceSpy.updateStatus.and.returnValue(of({} as any));
    ...
    it('should use correct action text when deactivating (nextStatus=false)', async () => {
      const onSuccessSpy = jasmine.createSpy('onSuccess');
      companyServiceSpy.updateStatus.and.returnValue(of({} as any));
