...
describe('DemandPredictionService', () => {
  ...
  describe('predict()', () => {
    it('should make POST request to predict-with-history with transformed payload', () => {
    ...
    it('should clamp horizon months between 1 and 24', () => {
    ...
    it('should clamp confidence between 0.5 and 0.99', () => {
    ...
    it('should normalize vehicle type to uppercase and default to CAR', () => {
      const mockResponse: PredictionResponseDto = {
        predictions: [],
        model_version: '1.0.0',
      };
    ...
    it('should map prediction response correctly with camelCase properties', () => {
      const request: DemandPredictionRequest = {
        vehicleType: 'CAR',
        brand: 'Toyota',
        model: 'Corolla',
    ...
    it('should handle empty predictions and history', () => {
      const mockResponse: PredictionResponseDto = {
        predictions: [],
        history: undefined,
        model_version: '1.0.0',
    ...
    it('should default horizon to 6 and confidence to 0.95 when not provided', () => {
      const mockResponse: PredictionResponseDto = {
        predictions: [],
        model_version: '1.0.0',
      };
  ...
  describe('getLatestModel()', () => {
    it('should make GET request to models/latest endpoint', () => {
    ...
    it('should map model metadata with all properties', () => {
      const mockResponse: LatestModelDto = {
        version: '2.0.0',
  ...
  describe('retrain()', () => {
    it('should make POST request to retrain endpoint with empty payload', () => {
    ...
    it('should propagate HTTP errors from retrain endpoint', () => {
      let errorReceived: any;
    ...
    it('should return retrain response with all properties', () => {
      const mockResponse: RetrainResponse = {
        version: '2.1.0',
