...
describe('PurchaseSaleService', () => {
  ...
  describe('searchPaginated()', () => {
    it('should GET paginated purchase-sales with default page and size', () => {
      const mock = {
        page: 0,
        items: [
          {
    ...
    it('should use custom page and size from filters', () => {
    ...
    it('should include all non-empty filter values in params', () => {
  ...
  describe('buildReportParams()', () => {
    it('should return empty params when both dates are undefined', () => {
      const params = (service as any).buildReportParams(undefined, undefined);

      expect(params.keys().length).toBe(0);
    });

    it('should return empty params when both dates are null', () => {
    ...
    it('should ignore null startDate and include endDate', () => {
    ...
    it('should ignore undefined startDate and include endDate', () => {
      const params = (service as any).buildReportParams(
        undefined,
        '2025-12-31',
      );
