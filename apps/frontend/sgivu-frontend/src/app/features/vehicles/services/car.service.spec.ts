...
describe('CarService', () => {
  ...
  describe('create()', () => {
    it('should POST new car and append to cars state', () => {
    ...
    it('should append to existing cars state when non-empty', () => {
  ...
  describe('getAll()', () => {
    it('should GET all cars and set cars state', () => {
      const mock = [
  ...
  describe('getAllPaginated()', () => {
    it('should GET paginated cars and set pager state', () => {
      const mock = {
        page: 2,
  ...
  describe('getCounts()', () => {
    it('should GET car counts and transform response', () => {
      const mock = {
        totalCars: 100,
        availableCars: 75,
        unavailableCars: 25,
  ...
  describe('update()', () => {
    it('should PUT updated car and update cars state', () => {
      const initial = [
    ...
    it('should not alter state when updating non-existing car', () => {
  ...
  describe('changeStatus()', () => {
    it('should PATCH car status and update cars state', () => {
  ...
  describe('delete()', () => {
    it('should DELETE car and remove from cars state', () => {
      const initial = [
  ...
  describe('search()', () => {
    it('should GET cars matching filters', () => {
  ...
  describe('searchPaginated()', () => {
    it('should GET paginated cars matching filters', () => {
      const mock = {
        page: 1,
