...
describe('PersonService', () => {
  ...
  beforeEach(() => {
    ...
    service.getPersonsPagerState().set({} as any);
  });
  ...
  describe('create()', () => {
    it('should POST new person and append to persons state', () => {
    ...
    it('should append to existing persons state when non-empty', () => {
      const existing = [
        {
          id: 2,
          firstName: 'Jane',
  ...
  describe('getAll()', () => {
    it('should GET all persons and set persons state', () => {
      const mock = [
        {
          id: 1,
          firstName: 'Alice',
  ...
  describe('getAllPaginated()', () => {
    it('should GET paginated persons and set pager state', () => {
      const mock = {
        page: 2,
        items: [
          {
  ...
  describe('update()', () => {
    it('should PUT updated person and update persons state', () => {
      const initial = [
        {
          id: 1,
          firstName: 'Old',
    ...
    it('should not alter state when updating non-existing person', () => {
      const initial = [
        {
          id: 2,
          firstName: 'Keep',
  ...
  describe('delete()', () => {
    it('should DELETE person and remove from persons state', () => {
      const initial = [
        {
          id: 1,
          firstName: 'Alice',
  ...
  describe('buildSearchParams()', () => {
    ...
    it('should exclude all empty values when none provided', () => {
      const params = (service as any).buildSearchParams({
        name: undefined,
        nationalId: '',
        email: null,
