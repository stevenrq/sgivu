...
describe('UserService', () => {
  ...
  describe('create()', () => {
    it('should POST new user and append to users state', () => {
    ...
    it('should append to existing users state when non-empty', () => {
  ...
  describe('getAll()', () => {
    it('should GET all users and set users state', () => {
      const mock = [
  ...
  describe('getAllPaginated()', () => {
    it('should GET paginated users and set pager state', () => {
      const mock = {
        page: 2,
  ...
  describe('update()', () => {
    it('should PUT updated user and update users state', () => {
      const initial = [
    ...
    it('should not alter state when updating non-existing user', () => {
  ...
  describe('delete()', () => {
    it('should DELETE user and remove from users state', () => {
      const initial = [
        buildUser({ id: 1, username: 'alice' }),
        buildUser({ id: 2, username: 'bob' }),
      ];
  ...
  describe('searchUsers()', () => {
    it('should GET users matching filters', () => {
      const mock = [
    ...
    it('should include boolean enabled filter stringified', () => {
      const mock = [] as any[];
  ...
  describe('searchUsersPaginated()', () => {
    it('should GET paginated users matching filters', () => {
      const mock = {
        page: 1,
    ...
    it('should include multiple filters in paginated search', () => {
