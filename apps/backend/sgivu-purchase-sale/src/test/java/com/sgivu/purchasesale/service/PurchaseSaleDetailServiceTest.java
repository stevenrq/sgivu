...
public class PurchaseSaleDetailServiceTest {
  ...
  class ToDetailsTests {
    ...
    @Test
    @DisplayName("should map contracts without external references")
    ...
    @Test
    @DisplayName("should enrich details with person, user and car and cache calls")
    ...
    @Test
    @DisplayName(
        "should fall back to company when person not found and then unknown when both missing")
    ...
    @Test
    @DisplayName("should try car then motorcycle then unknown for vehicle resolution")
    ...
    @Test
    @DisplayName("should use fallback user summary when user not found")
  ...
  class ToDetailTests {
    ...
    @Test
    @DisplayName("toDetail returns mapped detail for single contract")
    ...
    @Test
    @DisplayName("toDetail returns null when mapper returns null")
    ...
    @Test
    @DisplayName("toDetail throws NullPointerException when contract is null")
