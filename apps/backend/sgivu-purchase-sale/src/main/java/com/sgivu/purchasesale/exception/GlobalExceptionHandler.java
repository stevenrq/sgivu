...
public class GlobalExceptionHandler {
  ...
  public ResponseEntity<Object> handleVehicleRegistrationException(
    ...
    body.put(DETAILS_KEY, exception.getMessage());
    body.put(STATUS_KEY, HttpStatus.UNPROCESSABLE_CONTENT.value());
  ...
  public ResponseEntity<Object> handleHttpMessageNotWritableException(
    ...
    if (isClientDisconnect(exception)) {
      logger.debug("Client disconnected before response was fully written.");
      return ResponseEntity.ok().build();
    }
    logger.error("Cannot write HTTP response.", exception);
    Map<String, Object> body = new HashMap<>();
