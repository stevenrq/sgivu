...
public class OpenApiConfig {
  ...
  OpenAPI customOpenAPI() {
    ...
    return new OpenAPI()
        .info(
            new Info()
                .title("SGIVU - API de Gestión de Compras y Ventas")
                .version("1.0.0")
                .description(
                    "API REST para gestionar compras y ventas de vehículos usados en el Sistema de"
                        + " Gestión de Inventario de Vehículos Usados (SGIVU). Proporciona"
                        + " operaciones CRUD, cambio de estado y búsqueda multi-criterio para"
                        + " backoffice de compras/ventas.")
                .contact(
                    new Contact()
                        .name("Steven")
