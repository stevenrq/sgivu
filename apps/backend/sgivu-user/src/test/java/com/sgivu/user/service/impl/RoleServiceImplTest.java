...
public class RoleServiceImplTest {
  ...
  class AddPermissionsTests {
    ...
    @Test
    @DisplayName("should return role unchanged if names is null or empty")
    ...
    @Test
    @DisplayName("should add permissions to role when found")
    ...
    @Test
    @DisplayName("should not add permissions if none found")
  ...
  class RemovePermissionsTests {
    ...
    @Test
    @DisplayName("should remove permissions from role when found")
    ...
    @Test
    @DisplayName("should not remove permissions if none found")
  ...
  class UpdatePermissionsTests {
    ...
    @Test
    @DisplayName("should clear permissions when names is null or empty")
    ...
    @Test
    @DisplayName("should replace permissions when new permissions found")
    ...
    @Test
    @DisplayName("should throw if permissions not found for names")
