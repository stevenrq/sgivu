...
public class UserServiceImplTest {
  ...
  class SaveUserTests {
    @Test
    @DisplayName("should encode password, assign roles, and save user")
    ...
    @Test
    @DisplayName("should assign USER role by default when saving user")
    ...
    @Test
    @DisplayName("should throw RoleRetrievalException if role not found")
    ...
    @Test
    @DisplayName("should throw exception if repository fails")
  ...
  class UpdateUserTests {
    @Test
    @DisplayName("should update user fields and encode password if provided")
    ...
    @Test
    @DisplayName("should update user fields and keep password if not provided")
  ...
  class ChangeStatusTests {
    @Test
    @DisplayName("should enable user when found")
    ...
    @Test
    @DisplayName("should disable user when found")
    ...
    @Test
    @DisplayName("should return false if user not found")
