    ...
    if (userOptional.isPresent()) {
      ...
      if (userUpdateRequest.getAddress() != null) {
        if (userToUpdate.getAddress() != null) {
          userToUpdate.getAddress().setStreet(userUpdateRequest.getAddress().getStreet());
          userToUpdate.getAddress().setNumber(userUpdateRequest.getAddress().getNumber());
          userToUpdate.getAddress().setCity(userUpdateRequest.getAddress().getCity());
        } else {
          userUpdateRequest.getAddress().setId(null);
      ...
      userToUpdate.setRoles(RolePermissionUtils.getRoles(userUpdateRequest, roleRepository));
