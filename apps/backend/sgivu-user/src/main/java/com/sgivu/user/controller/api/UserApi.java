...
public interface UserApi {
  ...
  @Operation(
      summary = "Obtiene múltiples usuarios por ids (batch)",
      description = "Evita N+1: carga múltiples usuarios en una sola query (WHERE id IN ...)")
  @ApiResponses(value = {@ApiResponse(responseCode = "200", description = "Usuarios encontrados")})
  @PostMapping("/batch")
  ResponseEntity<List<UserResponse>> getByIds(
      @Parameter(description = "Lista de IDs de usuarios") @RequestBody List<Long> ids);
