...
public class OpenApiConfig {
  ...
  OpenAPI customOpenAPI() {
    ...
    return new OpenAPI()
        .info(
            new Info()
                .title("SGIVU - API de Gestión de Usuarios")
                .version("1.0.0")
                .description(
                    "API REST para administrar usuarios, roles y permisos del Sistema de Gestión de"
                        + " Inventario de Vehículos Usados (SGIVU). Proporciona operaciones CRUD,"
                        + " cambio de estado y búsqueda multi-criterio para backoffice de"
                        + " ventas/contratos.")
                .contact(
                    new Contact()
                        .name("Steven")
