...
public class AbstractClientServiceImplTest {
  ...
  class UpdateTests {
    ...
    @Test
    @DisplayName("should update existing client fields and save")
  ...
  class ChangeStatusTests {
    ...
    @Test
    @DisplayName("should enable client when found")
    ...
    @Test
    @DisplayName("should disable client when found")
    ...
    @Test
    @DisplayName("should return false if client not found")
