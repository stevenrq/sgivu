...
public interface PersonApi {
  ...
  @Operation(
      summary = "Obtiene múltiples personas por ids (batch)",
      description = "Evita N+1: carga múltiples personas en una sola query")
  @PostMapping("/batch")
  ResponseEntity<List<PersonResponse>> getByIds(
      @RequestBody @Parameter(description = "Lista de IDs de personas") List<Long> ids);
