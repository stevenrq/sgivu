...
public interface CompanyApi {
  ...
  @Operation(
      summary = "Obtiene múltiples empresas por ids (batch)",
      description = "Evita N+1: carga múltiples empresas en una sola query")
  @PostMapping("/batch")
  ResponseEntity<List<CompanyResponse>> getByIds(
      @RequestBody @Parameter(description = "Lista de IDs de empresas") List<Long> ids);
