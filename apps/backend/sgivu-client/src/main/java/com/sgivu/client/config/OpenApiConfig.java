...
public class OpenApiConfig {
  ...
  OpenAPI customOpenAPI() {
    ...
    return new OpenAPI()
        .info(
            new Info()
                .title("SGIVU - API de Gestión de Clientes")
                .version("1.0.0")
                .description(
                    "API REST para administrar clientes del Sistema de Gestión de"
                        + " Inventario de Vehículos Usados (SGIVU). Proporciona operaciones CRUD y"
                        + " búsqueda multi-criterio para el módulo de clientes.")
                .contact(
                    new Contact()
                        .name("Steven")
