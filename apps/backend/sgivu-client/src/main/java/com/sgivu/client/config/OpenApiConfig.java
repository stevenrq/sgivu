    ...
    return new OpenAPI()
        .info(
            new Info()
                ...
                .version("0.1.0")
                .description(
                    "API REST para administrar clientes del Sistema de Gestión Inteligente de"
                        + " Vehículos Usados (SGIVU). Proporciona operaciones CRUD y búsqueda"
                        + " multi-criterio para el módulo de clientes.")
                .contact(
                    new Contact()
                        .name("Steven")
