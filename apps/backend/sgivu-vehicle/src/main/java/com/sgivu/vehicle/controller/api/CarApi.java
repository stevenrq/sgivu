...
public interface CarApi {
  ...
  @Operation(
      summary = "Obtiene múltiples autos por ids (batch)",
      description = "Evita N+1 en resolvers: carga múltiples autos en una sola query")
  @PostMapping("/batch")
  ResponseEntity<List<CarResponse>> getByIds(
      @RequestBody @Parameter(description = "Lista de IDs de autos") List<Long> ids);
