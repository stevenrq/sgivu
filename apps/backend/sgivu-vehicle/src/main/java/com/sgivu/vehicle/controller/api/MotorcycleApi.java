...
public interface MotorcycleApi {
  ...
  @Operation(
      summary = "Obtiene múltiples motos por ids (batch)",
      description = "Evita N+1 en resolvers: carga múltiples motos en una sola query")
  @PostMapping("/batch")
  ResponseEntity<List<MotorcycleResponse>> getByIds(
      @RequestBody @Parameter(description = "Lista de IDs de motos") List<Long> ids);
