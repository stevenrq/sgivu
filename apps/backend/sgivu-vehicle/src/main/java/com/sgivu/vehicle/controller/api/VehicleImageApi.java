...
@Tag(name = "Imágenes de Vehículos", description = "Operaciones para subir, confirmar y listar imágenes")
...
public interface VehicleImageApi {
  ...
  ResponseEntity<VehicleImagePresignedUploadResponse> createPresignedUploadUrl(
      ...
      @RequestBody @Parameter(description = "Solicitud con tipo de archivo") VehicleImagePresignedUploadRequest request);
  ...
  ResponseEntity<VehicleImageConfirmUploadResponse> confirmUpload(
      @PathVariable @Parameter(description = "ID del vehículo") Long vehicleId,
      @RequestBody @Parameter(description = "Datos de la imagen subida") VehicleImageConfirmUploadRequest request);

  @Operation(summary = "Lista imágenes de un vehículo")
  @GetMapping
  ResponseEntity<List<VehicleImageResponse>> getImages(@PathVariable @Parameter(description = "ID del vehículo") Long vehicleId);
