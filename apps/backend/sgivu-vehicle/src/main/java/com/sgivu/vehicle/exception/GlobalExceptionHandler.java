...
public class GlobalExceptionHandler {
  ...
  public ResponseEntity<Object> handleStorageUnavailableException(StorageUnavailableException e) {
    logger.warn("Storage service unavailable: {}", e.getMessage());

    Map<String, Object> errorResponse = new HashMap<>();
    errorResponse.put(
        MESSAGE_KEY,
        "El servicio de almacenamiento no está disponible en este momento. Intente más tarde.");
    errorResponse.put(STATUS_KEY, HttpStatus.SERVICE_UNAVAILABLE.value());
