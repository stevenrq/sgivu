...
public class S3ServiceImplTest {
  ...
  class GeneratePresignedUploadUrlTests {
    ...
    @Test
    @DisplayName("should return presigned URL when presigner succeeds")
    ...
    @Test
    @DisplayName("should propagate exception when presigner fails")
  ...
  class UploadFileTests {
    ...
    @Test
    @DisplayName("should return true when putObject response is successful")
    ...
    @Test
    @DisplayName("should return false when putObject response is not successful")
    ...
    @Test
    @DisplayName("should propagate exception when putObject throws")
