...
public class VehicleImageServiceImplTest {
  ...
  class CreatePresignedUploadUrlTests {
    ...
    @Test
    @DisplayName("should throw when contentType is null or blank")
    ...
    @Test
    @DisplayName("should throw when contentType is not allowed")
    ...
    @Test
    @DisplayName("should return presigned response for allowed content type")
  ...
  class ConfirmUploadTests {
    ...
    @Test
    @DisplayName("should throw when key is null or blank")
    ...
    @Test
    @DisplayName("should throw when key prefix is invalid for vehicle")
    ...
    @Test
    @DisplayName("should throw when S3 reports key not found")
    ...
    @Test
    @DisplayName("should delete object and throw when fileName already exists")
    ...
    @Test
    @DisplayName("should delete object and throw when key already exists")
    ...
    @Test
    @DisplayName("should save image and mark as primary when vehicle has no images")
    ...
    @Test
    @DisplayName("should unset previous primary images when new image is primary")
  ...
  class DeleteImageTests {
    ...
    @Test
    @DisplayName("should delete non-primary image without promoting")
    ...
    @Test
    @DisplayName(
        "should promote next primary when deleted image was primary and remaining not empty")
