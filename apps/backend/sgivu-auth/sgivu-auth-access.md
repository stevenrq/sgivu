...
- Mantener `src/environments/environment.development.ts` en el repo [sgivu-frontend](https://github.com/stevenrq/sgivu-frontend) con
...
## 3. Recomendaciones practicas (WSL + Windows)
