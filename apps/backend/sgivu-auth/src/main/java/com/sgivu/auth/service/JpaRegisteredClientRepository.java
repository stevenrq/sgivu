...
public class JpaRegisteredClientRepository implements RegisteredClientRepository {
  ...
  private static AuthorizationGrantType resolveAuthorizationGrantType(
    ...
    // Para tipos de concesión de autorización personalizados
  ...
  private static ClientAuthenticationMethod resolveClientAuthenticationMethod(
    ...
    // Para métodos de autenticación de clientes personalizados
  ...
  public RegisteredClient findByClientId(String clientId) {
    Assert.hasText(clientId, "clientId no puede estar vacío");
