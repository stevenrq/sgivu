...
public class JpaOAuth2AuthorizationConsentServiceTest {
  ...
  class ToEntityTests {
    ...
    @Test
    @DisplayName(
        "should convert OAuth2AuthorizationConsent to AuthorizationConsent with authorities")
    ...
    @Test
    @DisplayName("should convert to entity with single authority")
  ...
  class ToObjectTests {
    ...
    @Test
    @DisplayName(
        "should convert AuthorizationConsent to OAuth2AuthorizationConsent with authorities")
    ...
    @Test
    @DisplayName("should throw DataRetrievalFailureException when registered client not found")
