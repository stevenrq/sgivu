...
public class JpaRegisteredClientRepositoryTest {
  ...
  class ToEntityTests {
    ...
    @Test
    @DisplayName("should convert RegisteredClient to Client entity with full fields")
    ...
    @Test
    @DisplayName("should convert RegisteredClient to Client entity with minimal fields")
  ...
  class ToObjectTests {
    ...
    @Test
    @DisplayName("should convert Client entity to RegisteredClient with full fields")
    ...
    @Test
    @DisplayName("should throw IllegalArgumentException when clientSettings JSON invalid")
  ...
  class ResolveAuthorizationGrantTypeTests {
    ...
    @Test
    @DisplayName("should return custom AuthorizationGrantType for unknown value")
  ...
  class ResolveClientAuthenticationMethodTests {
    ...
    @Test
    @DisplayName("should return CLIENT_SECRET_BASIC when input equals 'client_secret_basic'")
    ...
    @Test
    @DisplayName("should return CLIENT_SECRET_POST when input equals 'client_secret_post'")
    ...
    @Test
    @DisplayName("should return NONE when input equals 'none'")
    ...
    @Test
    @DisplayName("should return custom ClientAuthenticationMethod for unknown value")
