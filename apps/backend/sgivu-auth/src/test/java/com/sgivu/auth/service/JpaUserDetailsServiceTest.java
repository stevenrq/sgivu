...
public class JpaUserDetailsServiceTest {
  ...
  class LoadUserByUsernameTests {
    ...
    @Test
    @DisplayName("should load user and map authorities and tag span")
    ...
    @Test
    @DisplayName("should throw UsernameNotFoundException when userClient returns null")
    ...
    @Test
    @DisplayName("should throw UsernameNotFoundException when client returns 404")
    ...
    @Test
    @DisplayName("should propagate runtime exceptions from client")
  ...
  class MapToGrantedAuthoritiesTests {
    ...
    @Test
    @DisplayName("should map roles and permissions to GrantedAuthority set")
