...
public class JpaOAuth2AuthorizationServiceTest {
  ...
  class ResolveAuthorizationGrantTypeTests {
    ...
    @Test
    @DisplayName("should return AuthorizationCode constant for 'authorization_code'")
    ...
    @Test
    @DisplayName("should return ClientCredentials constant for 'client_credentials'")
    ...
    @Test
    @DisplayName("should return RefreshToken constant for 'refresh_token'")
    ...
    @Test
    @DisplayName(
        "should return DeviceCode constant for 'urn:ietf:params:oauth:grant-type:device_code'"
            + " (device_code constant)")
    ...
    @Test
    @DisplayName("should return a custom AuthorizationGrantType for unknown grant types")
  ...
  class ParseMapTests {
    ...
    @Test
    @DisplayName("should parse valid JSON into a Map")
  ...
  class WriteMapTests {
    ...
    @Test
    @DisplayName("should write simple map to JSON and round-trip via parseMap")
    ...
    @Test
    @DisplayName("should include type info for CustomUserDetails and parse back to instance")
    ...
    @Test
    @DisplayName("should write null map as 'null'")
  ...
  class ToEntityTests {
    ...
    @Test
    @DisplayName("should convert authorization with tokens and attributes to entity")
    ...
    @Test
    @DisplayName("should convert minimal authorization to entity without tokens")
  ...
  class ToObjectTests {
    ...
    @Test
    @DisplayName(
        "should convert Authorization entity to OAuth2Authorization with tokens and attributes")
    ...
    @Test
    @DisplayName("should throw DataRetrievalFailureException when registered client missing")
