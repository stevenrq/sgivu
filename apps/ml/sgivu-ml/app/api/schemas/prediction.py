"""Schemas de la API para predicciones de demanda.

Definen los modelos de request/response usados en los endpoints.
Son independientes de las entidades de dominio para permitir
evolución independiente del contrato de la API.
"""
