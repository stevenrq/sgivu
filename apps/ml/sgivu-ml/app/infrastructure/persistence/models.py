"""Modelos ORM de SQLAlchemy para el microservicio de ML."""
...
class ModelArtifact(Base):
    """Artefacto de modelo de ML almacenado en base de datos."""
...
class TrainingFeature(Base):
    """Snapshot de features de entrenamiento por segmento y mes."""
...
class DriftRecord(Base):
    """Registro de drift: predicción vs valor real."""
...
class PredictionRecord(Base):
    """Registro de auditoría de predicciones realizadas."""
