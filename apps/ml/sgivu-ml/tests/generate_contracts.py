...
# Estacionalidad por mes calendario (igual que el SQL: pico en diciembre, valle en enero).
...
def generate_csv(path):
    ...
    with open(path, "w", newline="", encoding="utf-8") as f:
        ...
        for s_idx in range(1, 40):
            ...
            for mb in range(1, HORIZON_MONTHS + 1):
                ...
                # Ventas de la celda (fecha = compra + 7..36 días, dentro o fuera del mes).
    ...
    print(
        ...
        f"(PURCHASE={purchase_count}, SALE={sale_count}, TOTAL={purchase_count + sale_count})"
    )
